Pod::Spec.new do |s|
  ...
  s.compiler_flags = '-DLIBSSH2_DSA_ENABLE=1 -DLIBSSH2_RSA=1 -DLIBSSH2_RSA_SHA2=1 -DLIBSSH2_RSA_SHA1=1 -DLIBSSH2_ECDSA=1 -DLIBSSH2_ED25519=1 -DOPENSSL_SUPPRESS_DEPRECATED"=1 -DHAVE_LIBSSL=1 -DLIBSSH2_OPENSSL=1 -DHAVE_LIBZ=1 -DLIBSSH2_HAVE_ZLIB=1 -DSTDC_HEADERS=1 -DHAVE_STDLIB_H=1 -DHAVE_STDIO_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_UNISTD_H=1 -DHAVE_ALLOCA=1 -DHAVE_ALLOCA_H=1 -DHAVE_ARPA_INET_H=1 -DHAVE_NETINET_IN_H=1 -DHAVE_SYS_SOCKET_H=1 -DHAVE_SYS_UN_H=1 -DHAVE_SYS_IOCTL_H=1 -DHAVE_SYS_PARAM_H=1 -DHAVE_SYS_SELECT_H=1 -DHAVE_SYS_TIME_H=1 -DHAVE_SYS_UIO_H=1 -DHAVE_GETTIMEOFDAY=1 -DHAVE_POLL=1 -DHAVE_SNPRINTF=1 -DHAVE_STRTOLL=1 -DHAVE_O_NONBLOCK=1 -DHAVE_FIONBIO=1'
